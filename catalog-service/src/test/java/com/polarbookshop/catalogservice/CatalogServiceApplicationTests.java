...
class CatalogServiceApplicationTests {
	...
	void whenPostRequestCreateBookAndWhenDeleteRequestDestroyBook() {
		...
		var book = Book.of(isbn, "AboutToDelete", "DeletedAuthor", 10.90, null);
	...
	void whenPutRequestBookEdited() {
		...
		var book = Book.of(isbn, "EditBook", "EditedAuthor", 4.40, null);
		...
		// put
		var editedBook = Book.of(isbn, "EditedBookNow", "NewAuthor", 100.10, null);
