...
public class BookValidationTests {
    ...
    void allFieldsCorrectShouldSucceed() {
        var book = new Book("1234567890", "TestTitle", "AuthorH", 10.90);
    ...
    void IsbnDefinedButIncorrectShouldFail() {
        var book = new Book("1234567890101001010102910", "TesterTitle", "AuthorF", 10.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
    ...
    void priceIsDefinedButNegativeShouldFail() {
        var book = new Book("1234567890", "TestTitle", "AuthorK", -10.21);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage()).isEqualTo(
